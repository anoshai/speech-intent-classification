<?php
session_start();
require_once('/var/www/html/voice-in-sinhala/conf/database_conn.php');
$mysqli = db_connect();
...
if($last_id != null){
    if ($mysqli->query("UPDATE voice_provider_sinhala SET username='$username', gender='$gender', age='$age', selected_symptom='$selectedDisease', selected_description='$selectedDescription' WHERE id='$last_id'")) {
