...
<div class="row">
    ...
    <div class="col-md-6">
        <div>
            <form name="voiceProviderDataForm4" method="post" action="/voice-in-sinhala/views/index.php">
                <button type="submit" class="btn btn-primary" id="exit" style="float: right;" disabled>Exit</button>
            </form>
        </div>
        <div>
            <form name="voiceProviderDataForm3" method="post" action="/voice-in-sinhala/views/voiceRecord1.php">
                <button type="submit" class="btn btn-primary" id="next1" style="float: right;" disabled>Next &raquo;
                </button>
            </form>
        </div>
    </div>
